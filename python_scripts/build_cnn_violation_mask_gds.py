...
DEFAULT_INPUT_LAYOUT = f"real_layouts_tt/{LAYOUT_NAME}.oas"
DEFAULT_REPORT_PATH = f"outputs/{LAYOUT_NAME}/drc_report.txt"
DEFAULT_MASK_OUTPUT = f"outputs/{LAYOUT_NAME}/cnn_violation_mask.gds"
DEFAULT_MERGED_OUTPUT = f"outputs/{LAYOUT_NAME}/tt_um_yen_with_cnn_mask.gds"
