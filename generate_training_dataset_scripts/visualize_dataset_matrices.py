...
from project_paths import training_dataset_dir

# Import parameters directly from the generator script
from generate_training_dataset import PHYSICAL_SIZE, STRIDE, IMAGE_SIZE
...
def visualize_dataset_matrices(clean_dir=CLEAN_DIR, dirty_dir=DIRTY_DIR):
    ...
    fig.suptitle(f"Dataset Sanity Check | Window: {PHYSICAL_SIZE}nm | Clip/Image Size: {IMAGE_SIZE}px | Res: {RESOLUTION:.1f}nm/px | Stride: {STRIDE}nm", 
