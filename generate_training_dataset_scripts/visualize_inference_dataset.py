...
from project_paths import inference_dataset_dir

# --- CONFIGURATION ---
LAYOUT_NAME = "tt_um_yen"
DATASET_PATH = inference_dataset_dir(LAYOUT_NAME)
...
if __name__ == "__main__":
    visualize_inference_dataset(str(DATASET_PATH), coords_list=SPECIFIC_LOCATIONS)