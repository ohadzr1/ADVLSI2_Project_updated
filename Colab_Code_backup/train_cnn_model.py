...
# Must match load_training_dataset.py (Colab cells share the same kernel namespace)
DATA_DIR = os.environ.get("TRAINING_DATA_DIR", "data")

dataset = DRCDataset(root_dir=DATA_DIR, transform=data_transforms)
