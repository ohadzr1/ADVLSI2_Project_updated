...
# --- CONFIGURATION ---
# Colab defaults; override locally with environment variables if needed.
COLAB_ROOT = Path(os.environ.get("COLAB_ROOT", "/content"))
ZIP_PATH = Path(os.environ.get("INFERENCE_ZIP", COLAB_ROOT / "inference_dataset.zip"))
...
# --- 3. Execute Inference ---
scan_layout_from_zip(model, str(ZIP_PATH), CONFIDENCE_THRESHOLD)
